      ...
      <section className="pt-32 pb-20 bg-petrol text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10 pt-4">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan/20 text-cyan text-sm font-bold mb-6">
            <Briefcase className="w-4 h-4" /> {service.code} · {service.family}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              {service.pricingType === 'sob-consulta' ? 'Pedir orçamento' : 'Solicitar contratação'}{' '}
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="md:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-slate-600 text-lg leading-relaxed mb-6">{service.fullDescription}</p>
            ...
            <div>
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm sticky top-32">
                ...
                <h3 className="text-xl font-bold text-petrol mb-2">Investimento</h3>
                <p className="text-slate-500 mb-6">
                  Valor referente exclusivamente ao serviço Velkor. Taxas oficiais e custos de
                  terceiros não estão inclusos.
                </p>
                <div className="py-4 border-y border-slate-100 mb-6">
                  <span className="text-sm text-slate-500 block mb-1">Valor</span>
                  <span className="text-2xl font-bold text-petrol">{service.priceLabel}</span>
                  {service.deadline && (
                ...
                >
                  {service.pricingType === 'sob-consulta' ? 'Pedir orçamento agora' : 'Contratar agora'}
                </button>
              </div>
            </div>
          </div>
