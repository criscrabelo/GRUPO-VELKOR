...
export function HeroSection() {
  const whatsappMessage = encodeURIComponent(
    'Olá, quero falar com a VELKOR sobre regularização/documentação imobiliária.',
  )
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan/10 text-cyan text-sm font-bold uppercase tracking-widest mb-8 border border-cyan/20 animate-fade-in-up">
            ...
            Despachante Documental Imobiliário
          </div>
          ...
          <p
            className="text-lg md:text-xl text-slate-600 mb-8 md:mb-10 leading-relaxed max-w-3xl animate-fade-in-up"
            style={{ animationDelay: '200ms' }}
          >
            A VELKOR cuida da parte administrativa e documental do seu imóvel: certidões,
            matrícula, ITBI, escritura, registro, averbações, Habite-se, CND de obra,
            financiamento documental e acompanhamento em cartórios, prefeituras e órgãos públicos.
            Quando necessário, conectamos você a advogados, engenheiros e outros profissionais
            habilitados.
          </p>
